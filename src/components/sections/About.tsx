...
const experiences = [
  {
    year: '2024 - 2025',
    role: 'Senior E-Commerce CMS Developer',
    company: 'Wick Creative',
  ...
  {
    year: '2022 - 2024',
    role: 'Lead Shopify & WooCommerce Developer',
    company: 'Trennder Agency',
    description: 'Led OS 2.0 theme dev with metaobjects, shipped PDP/bundle/B2B apps, integrated subs/reviews/UGC/search, stabilized multi-market checkout, automated catalog/order ops, and improved SEO/performance to grow organic traffic and rankings.',
  },
  {
    year: '2020 - 2022',
    role: 'Full Stack Developer',
    company: 'Punch',
    description: 'Customized Shopify and regional CMS platforms; integrated Japan-specific payments (Konbini/PayPay/Paidy) and localized checkout experiences.',
  },
  {
    year: '2017 - 2020',
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-10 pt-5">
                {stats.map((stat, index) => (
                  ...
                  >
                    <motion.div
                      className="inline-flex items-center justify-center w-10 h-10 bg-blue-100 text-blue-600 rounded-lg mb-3 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300"
